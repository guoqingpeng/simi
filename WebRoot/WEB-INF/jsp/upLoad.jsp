...
<div class="doc">
    <div class="doc-bd">
        ...
        <div class="m-upload">
            ...
            <p class="red">(第一张上传的照片将用于投票活动结束之后的公益活动，请认真选择！)</p>
        </div>
        ...
        <div class="m-dialect">
            <div class="record">
                ...
                <p class="tips">(请用方言朗读以上文字<i class="blue">30秒以内</i>,上传录音后可获得1000身价)</p>
            ...
            <div class="btn-box">
                ...
                <div id="j-save" class="mt10 split">
                    <p class="tips" style="padding: 0 15px 10px 15px; text-align:left">因微信服务器问题，上传照片或录音时可能会有卡顿，请耐心等待，如果上传失败请稍后再进行注册。</p>
